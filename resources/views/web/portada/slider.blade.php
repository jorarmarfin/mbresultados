	...
	<div id="revolutionSlider" class="slider rev_slider manual">
		<ul>
			<li data-transition="fade">
				<img src="img/demos/business-consulting/slides/slide-1.jpg"
					alt=""
				...
				<h1 class="tp-caption custom-secondary-font font-weight-bold text-color-light"
					...
					data-start="800"
					data-transform_in="y:[-300%];opacity:0;s:500;" style="font-size: 32px;">Implementacion y auditorias</h1>

				<div class="tp-caption custom-secondary-font font-weight-bold text-color-light"
					data-x="['left','left','left','left']" data-hoffset="['30','30','30','30']"
					data-y="center" data-voffset="['-42','-42','-42','2']"
					data-start="800"
					data-transform_in="y:[-300%];opacity:0;s:500;" style="font-size: 42px;">de Normas Internacionales</div>
			...
			<li data-transition="fade">
				...
				<div class="tp-caption custom-secondary-font font-weight-bold text-color-light"
					...
					data-y="center" data-voffset="['-42','-42','-42','2']"
					data-start="800"
					data-transform_in="y:[-300%];opacity:0;s:500;" style="font-size: 42px;">Auditorias de Certificación</div>

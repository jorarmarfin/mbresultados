...
<div class="row">
    <div class="col-md-12">
		...
		{!! Form::model($curso,['route'=>['admin.curso.update',$curso],'method'=>'PUT','files'=>'true']) !!}
			<img src="{{ $curso->ver_imagen }}" width="25%"><p>imagen del curso Tamaño recomendado 371*255</p>
{!! Field::file('imagen',['label'=>'Imagen del curso','class'=>'bg-grey-steel margin-bottom-10','template'=>'themes.metronic.fields.texth']) !!}
